...
def get_pipelinerun_image_url(pipelinerun_name: str) -> str:
    """
    ...
    """
    pipelinerun_status = _fetch_pipelinerun_status(pipelinerun_name)

    status = pipelinerun_status.get('status', {})
