...
def handle_recursive_related_bundles_request(
    ...
    with set_registry_auths(registry_auths):
        ...
        payload: UpdateRequestPayload = {
            ...
            'state': 'in_progress',
            'state_reason': f'Finding recursive related bundles for the bundle: {parent_bundle_image}',
        }
        ...
        while not traversal_completed:
            ...
            for bundle in temp_current_level_related_bundles:
                ...
                if total_related_bundles >= conf.iib_max_recursive_related_bundles:
                    raise IIBError('Max number of related bundles exceeded. Potential DDOS attack!')
